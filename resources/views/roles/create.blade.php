...
@section('content')
    <div class="page-header mb-4">
        <h1 class="mb-0">Tambah Role Baru</h1>
        <p class="text-secondary">Definisikan peran baru dan izin aksesnya</p>
    </div>
        ...
        <form action="{{ route('roles.store') }}" method="POST">
            ...
            <div class="form-group mb-4">
                ...
                <input type="text" name="name" value="{{ old('name') }}" required
                    placeholder="Contoh: Admin Lokasi Kantor">
            </div>

            <div class="form-group mb-6">
                <label>Catatan/Penjelasan</label>
                <textarea name="notes" rows="2" placeholder="Deskripsi singkat tentang peran ini...">{{ old('notes') }}</textarea>
            </div>
