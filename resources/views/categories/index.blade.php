<div style="display:flex; justify-content: space-between; align-items: center;">
    ...
    <nav>
        ...
        <a href="{{ route('categories.index') }}"
            style="text-decoration: underline; font-weight: bold; color: #1890ff;">Categories</a> |
        <a href="{{ route('locations.index') }}"
            style="text-decoration: none; font-weight: bold; color: #1890ff;">Locations</a> |
        <a href="{{ route('settings.index') }}"
            style="text-decoration: none; font-weight: bold; color: #52c41a;">Settings</a>
    </nav>
</div>

<a href="#" onclick="replacePage('{{ route('categories.create') }}')"
    ...
    <tbody>
        @forelse ($categories as $category)
            <tr>
                ...
                <td>
                    <a href="#" onclick="replacePage('{{ route('categories.edit', $category->id) }}')">Edit</a>
