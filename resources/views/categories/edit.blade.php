...
@section('content')
    <div class="page-header mb-4">
        ...
        <p class="text-secondary">Pembaruan informasi kategori: <strong>{{ $category->name }}</strong></p>
    </div>
        ...
        <form action="{{ route('categories.update', $category->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="unique_code" id="unique_code"
                    value="{{ old('unique_code', $category->unique_code) }}" minlength="4" maxlength="16" required
                ...
                <div id="code_warning" class="alert alert-warning py-3 mt-3 mb-0"
                    ...
                    Anda mengubah Kode Unik. Perubahan ini akan memperbarui <strong>{{ $itemCount }} barang</strong> yang
                    terhubung.

                    @if ($itemCount > 50)
                        <p class="mt-2 mb-0" style="font-size: 0.8rem;"><i>*Karena jumlah barang banyak, pembaruan akan
                                diproses di latar belakang.</i></p>
                    @endif
            ...
            <div class="form-group">
                ...
                <textarea name="description" placeholder="Penjelasan singkat mengenai kategori ini...">{{ old('description', $category->description) }}</textarea>
            </div>
