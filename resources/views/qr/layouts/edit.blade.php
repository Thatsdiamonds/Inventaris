...
@section('content')
    <div class="page-header mb-4">
        <div class="row align-items-center">
            <div class="col-md-6 col-sm-12">
                <h1 class="page-title">Edit Layout Label</h1>
                <p class="text-secondary">Ubah konfigurasi dimensi fisik label.</p>
            </div>
    ...
    <form action="{{ route('label-layouts.update', $layout->id) }}" method="POST" id="layoutForm">
        @csrf
        @method('PUT')
            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="paper_size" class="form-select">
                            <option value="A4" {{ $layout->paper_size == 'A4' ? 'selected' : '' }}>A4 (210mm x 297mm)
                            </option>
                            <option value="Letter" {{ $layout->paper_size == 'Letter' ? 'selected' : '' }}>Letter (215.9mm x
                                279.4mm)</option>
                            <option value="Custom" {{ $layout->paper_size == 'Custom' ? 'selected' : '' }}>Custom</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-3">
                        ...
                        <input type="number" step="0.1" name="margin_top" class="form-control"
                            value="{{ $layout->margin_top }}" required>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label required">Bawah</label>
                        <input type="number" step="0.1" name="margin_bottom" class="form-control"
                            value="{{ $layout->margin_bottom }}" required>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label required">Kiri</label>
                        <input type="number" step="0.1" name="margin_left" class="form-control"
                            value="{{ $layout->margin_left }}" required>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label required">Kanan</label>
                        <input type="number" step="0.1" name="margin_right" class="form-control"
                            value="{{ $layout->margin_right }}" required>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" step="0.1" name="gap_x" class="form-control"
                            value="{{ $layout->gap_x }}" required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label required">Gap Vertikal (Y)</label>
                        <input type="number" step="0.1" name="gap_y" class="form-control"
                            value="{{ $layout->gap_y }}" required>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" step="1" name="font_size" class="form-control"
                            value="{{ $layout->font_size }}" required>
                    </div>
